...
<!--End of Tawk.to Script-->
	...
	<div class="inner" style="text-align: justify;">
        ...
        <img src="images/info2.jpg" alt="Gambar Bela Negara" style="display: block; margin: 0 auto;">
        <p style="margin-top: 20px;"></p>
		<p>
			Bela Negara adalah sikap dan perilaku warga negara yang dijiwai oleh kecintaan kepada Negara Kesatuan Republik Indonesia (NKRI) yang berdasarkan Pancasila dan UUD 1945 dalam menjamin kelangsungan hidup bangsa dan negara. Sebagai Kampus Bela Negara, diharapkan UPN "Veteran" Jawa Timur mampu menghasilkan lulusan sarjana Pionir Pembanguan yang selalu siap mempertahankan NKRI, Pancasila, dan UUD 1945 dimanapun dan kapanpun bekerja.
		</p>
		<p>
			<b>Nilai-Nilai Bela Negara :</b><br>
			1. Cinta Tanah Air Republik Indonesia, mengenal dan mencintai wilayah nasional, selalu waspada, siap membela NKRI terhadap segala bentuk ancaman.<br>
			2. Kesadaran berbangsa dan bernegara Indonesia, selalu membina kerukunan, persatuan, dan kesatuan, selalu mengutamakan kepentingan bangsa di atas kepentingan pribadi atau golongan, memahami lambang negara, lagu kebangsaan, dan mentaati seluruh perundang-undangan yang berlaku.<br>
			3. Meyakini kebenaran Pancasila sebagai falsafah dan ideologi negara.<br>
			4. Rela berkorban bagi bangsa dan negara.<br>
			5. Memiliki kemampuan awal Bela Negara.
		</p>
		<p>
			Sebagai Perguruan Tinggi di bawah pembinaan Kementrian Pertahanan, UPN "Veteran" Jawa Timur memiliki fungsi strategis dalam menghasilkan lulusan yang memiliki jiwa kejuangan dalam mempertahankan Negara Kesatuan Republik Indonesia (NKRI). asal 27 ayart 3 UUD 1945 menyebutkan “setiap warga negara berhak dan wajib ikut serta dalam upaya pembelaan negara”.
		</p>
		<p>
